...
class ConfigBF:
    ...
    noise_init = 4 # noise initial parameter
    max_epoch = 100  # maximum epoch during training
    learning_rate = 1e-2 # initial learning rate
    lr_decays = {i: 0.95for i in range(0, 500)}  # decay rate of learning rate
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        if dataset_name is 'BF':
            num_per_class = np.array([569265, 1843263, 3574466, 10393913, 1490909, 7591659, 7637344,
                                    1270869], dtype=np.int32)
        ...
        weight = num_per_class /np.array(float(sum(num_per_class)))
